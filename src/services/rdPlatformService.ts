...
export class RdPlatformService {
    ...
    static async updateRequirement(
        ...
        if (params.organizationId !== undefined) {
            body.org_id = Number(params.organizationId);
        }
        if (params.iteration !== undefined) {
            body.iteration = params.iteration;
        }
    ...
    static async updateBug(id: string, params: Partial<Omit<Bug, "id" | "createdAt" | "updatedAt">>): Promise<Bug | null> {
        ...
        if (params.relatedRequirementId !== undefined) {
            body.related_requirement_id = params.relatedRequirementId;
        }
        if (params.module !== undefined) {
            body.module = params.module;
        }
        if (params.stepsToReproduce !== undefined) {
            body.steps_to_reproduce = params.stepsToReproduce;
        }
    ...
    static async updateTask(id: string, params: Partial<Omit<Task, "id" | "createdAt" | "updatedAt">>): Promise<Task | null> {
        ...
        if (params.requirementId !== undefined) {
            body.requirement_id = params.requirementId;
        }
        if (params.deadline !== undefined) {
            body.deadline = dateToUnix(params.deadline || "");
        }
        if (params.estimatedHours !== undefined) {
            body.estimated_hours = params.estimatedHours;
        }
