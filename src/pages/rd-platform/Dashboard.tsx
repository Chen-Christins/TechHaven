...
import type { RdStats, Requirement, Bug, Task } from "@/types/RdPlatform.ts";
                        ...
                        <tbody>
                            {recentRequirements.map((r) => (
                                ...
                                >
                                    ...
                                    <td data-label="优先级">
                                        <span className={`${styles.badge} ${styles[`priority_${r.priority}`]}`}>
                        ...
                        <tbody>
                            {recentBugs.map((b) => (
                                ...
                                >
                                    ...
                                    <td data-label="状态">
                                        <span className={`${styles.badge} ${styles[`status_${b.status}`]}`}>
