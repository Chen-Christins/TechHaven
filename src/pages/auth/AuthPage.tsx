      ...
      <div className={styles.mainContent}>
        <div className={styles.authCard}>
          ...
          <div className={styles.content}>
            {/* 返回按钮（除了登录页） */}
            {formType !== "login" && (
              <button onClick={() => switchForm("login")} className={styles.backButton}>
                <ArrowLeft size={18} />
                <span>返回登录</span>
              </button>
            )}
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
                ...
                <>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.formControl}>
                      ...
                      />
                      <button type="button" onClick={() => setShowPassword(!showPassword)} className={styles.actionButton}>
              ...
              {formType === "register" && (
                <>
                  ...
                  <div className={styles.formGroup}>
                    <label htmlFor="auth_code" className={styles.label}>
                      验证码
                    </label>
                    <div className={styles.formControl}>
                      <Mail size={18} className={styles.icon} />
                      <input
                        ...
                        placeholder="请输入验证码"
                      />
                      <button type="button" onClick={handleSendCode} disabled={countdown > 0} className={styles.actionButton}>
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <div className={styles.formControl}>
                      ...
                      <input
                        ...
                        autoComplete="new-password"
                      />
                      <button type="button" onClick={() => setShowNewPassword(!showNewPassword)} className={styles.actionButton}>
              ...
              {/* 提交按钮 */}
              <button type="submit" disabled={isSubmitting} className={`${styles.btn} ${styles.primaryBtn}`}>
                {isSubmitting ? (
              ...
              <div className={styles.formSwitch}>
                {formType === "login" ? (
                  ...
                  <div>
                    已有账号？
                    <button type="button" onClick={() => switchForm("login")} className={`${styles.btn} ${styles.textBtn}`}>
                      立即登录
                    </button>
                  </div>
                ) : (
