...
const mockArticles: Article[] = [
    {
        ...
        content:
            "深入探讨React Hooks的使用技巧，如何避免常见陷阱，以及提升组件性能的各种策略。通过实际案例分析，掌握高级Hook用法。",
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.leftColumn}>
                    ...
                    <div className={styles.articlesSection}>
                        ...
                        <div
                            className={`${styles.articlesList} ${viewMode === "grid" ? styles.gridView : styles.listView}`}
                        >
