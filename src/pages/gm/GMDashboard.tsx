...
const GMDashboard: React.FC = () => {
  ...
  const templates = useMemo<CommandTemplate[]>(
    () => [
      ...
      { label: "临时护盾", command: "/buff shield 600", icon: <FaMagic /> },
    ],
    [],
  );
    ...
    <>
      ...
      >
        <div>
          ...
          <p className={styles.subtitle}>快速派发 GM 指令、资源补偿与全服公告。</p>
      ...
      <div className={styles.grid}>
        ...
        >
          ...
          <div className={styles.inlineActions}>
            <Button color="primary" variant="solid" size="medium" onClick={() => message.info("查询中（模拟）")}>
              <FaSearch /> 快速查询
            </Button>
            <Button color="primary" variant="outline" size="medium" onClick={() => message.info("获取状态（模拟）")}>
            ...
            {templates.map((tpl, index) => (
              <div key={tpl.label} className={styles.templateCard}>
                ...
                <div className={styles.templateActions}>
                  ...
                  <Button size="small" variant="outline" color="secondary" onClick={() => copyCommand(tpl.command, index)}>
