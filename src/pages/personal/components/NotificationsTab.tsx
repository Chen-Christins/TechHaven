...
const MOCK_NOTIFICATIONS: NotificationItem[] = [
  {
    id: 1, type: "system", title: "系统维护通知",
    content: "本站将于 2026-05-15 凌晨 2:00-4:00 进行服务器升级维护，届时部分功能可能暂时不可用，敬请谅解。",
    is_read: false, create_time: NOW - 120,
  },
  {
    id: 2, type: "comment", title: "张三 评论了你的文章",
    content: "这篇关于 React 状态管理的文章写得太好了，尤其是 useReducer 和 Context 结合使用的部分！",
    is_read: false, create_time: NOW - 600, link: "/article/1",
  },
  {
    id: 3, type: "like", title: "李四 点赞了你的文章",
    content: "你的文章《TypeScript 高级类型技巧》获得了 1 个赞",
    is_read: false, create_time: NOW - 1800, link: "/article/2",
  },
  {
    id: 4, type: "follow", title: "王五 关注了你",
    content: "王五 开始关注你，你们现在可以互相看到对方的动态了",
    is_read: false, create_time: NOW - 3600, link: "/profile/wangwu",
  },
  {
    id: 5, type: "article", title: "你关注的文章已更新",
    content: "《深入理解 Vite 插件机制》发布了新章节「插件钩子执行顺序详解」",
    is_read: false, create_time: NOW - 7200, link: "/article/3",
  },
  {
    id: 6, type: "comment", title: "赵六 回复了你的评论",
    content: "同意你的观点，不过我觉得还可以补充一下关于异步更新的处理方式",
    is_read: false, create_time: NOW - 10800, link: "/article/1",
  },
  {
    id: 7, type: "like", title: "你的评论获得了 5 个赞",
    content: "你在文章《CSS Grid 布局实战》中的评论「Grid 配合 subgrid 可以实现非常灵活的嵌套布局」获得了 5 个赞",
    is_read: false, create_time: NOW - 18000,
  },
  {
    id: 8, type: "system", title: "欢迎加入 TechBlog",
    content: "感谢你的注册！你可以在个人中心完善资料，或直接开始撰写你的第一篇文章。",
    is_read: true, create_time: NOW - 86400,
  },
  {
    id: 9, type: "follow", title: "孙七 关注了你",
    content: "孙七 开始关注你",
    is_read: true, create_time: NOW - 172800,
  },
  {
    id: 10, type: "article", title: "你的文章入选了精选推荐",
    content: "恭喜！你的文章《React 性能优化实战》已被编辑推荐到首页精选栏目，预计将获得更多曝光。",
    is_read: true, create_time: NOW - 259200, link: "/article/4",
  },
  {
    id: 11, type: "like", title: "你的文章获得了 10 个赞",
    content: "《Node.js 微服务架构设计》获得了 10 个赞",
    is_read: true, create_time: NOW - 432000, link: "/article/5",
  },
  {
    id: 12, type: "comment", title: "周八 评论了你的文章",
    content: "学到了",
    is_read: true, create_time: NOW - 604800, link: "/article/2",
  },
  {
    id: 13, type: "system", title: "账号安全提醒",
    content: "检测到你的账号在一台新设备上登录，如非本人操作请及时修改密码。登录地点：广东深圳，登录时间：2026-05-10 14:30",
    is_read: true, create_time: NOW - 1209600,
  },
  {
    id: 14, type: "follow", title: "郑九 关注了你",
    content: "郑九 开始关注你",
    is_read: true, create_time: NOW - 2592000,
  },
  {
    id: 15, type: "like", title: "你的文章获得了 32 个赞",
    content: "《前端工程化实践》获得了 32 个赞",
    is_read: true, create_time: NOW - 5184000,
  },
];
    ...
    <div>
      <div className={styles.pageHeader}>
        <div className={styles.pageHeaderLeft}>
          ...
          {unreadCount > 0 && (
            <span className={styles.unreadBadge}>{unreadCount} 条未读</span>
          )}
        </div>
        {unreadCount > 0 && (
        ...
        {loading ? (
          ...
          notifications.map((item) => {
            ...
            return (
              ...
              >
                <div className={`${styles.notifItemIcon} ${meta.className}`}>
                  {meta.icon}
                </div>
