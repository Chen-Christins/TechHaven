...
const MyArticlesTab: React.FC = () => {
    ...
    const [statusFilter, setStatusFilter] = useState<
        "all" | "published" | "draft" | "private" | "unallowed" | "reviewing"
    >("all");
    ...
    const handleStatusChange = (selectedOption: SelectOption | null) => {
        ...
        const newStatus = selectedOption
            ? (selectedOption.id as "all" | "published" | "private" | "unallowed" | "reviewing")
            : "all";
    ...
    const handleToggleStatus = async (
        ...
        try {
            if (newStatus === "reviewing") {
                ...
                setArticles(
                    articles.map((article) => (article.id === id ? { ...article, state: newStatus } : article)),
                );
            }
