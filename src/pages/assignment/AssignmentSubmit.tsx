          ...
          <div className={styles.card}>
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              <div className={styles.infoGrid}>
                <div className={styles.infoCard}>
                  ...
                  <span className={`${styles.infoValue} ${styles.deadlineValue}`}>{formatDate(assignment.end_time)}</span>
                </div>
                <div className={styles.infoCard}>
            ...
            <div>
              ...
              <div className={styles.uploadContainer}>
                ...
                >
                  ...
                  <div className={styles.uploadContent}>
                    ...
                    <div className={styles.uploadLimit}>单个文件不超过 {Math.round(assignment.file_size)}MB</div>
                  </div>
                </div>
                  ...
                  <div className={styles.fileList}>
                    {files.map((file, index) => (
                      <div key={index} className={styles.fileItem}>
                        ...
                        <button className={styles.deleteBtn} onClick={() => removeFile(index)} title="移除文件">
                          <FaTrash />
                        </button>
                      </div>
                    ))}
              ...
              <div className={styles.actionBar}>
                <button className={`${styles.btn} ${styles.btnSecondary}`} onClick={() => navigate(-1)} disabled={submitting}>
                  取消
                </button>
                <button
