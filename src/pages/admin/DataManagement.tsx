    ...
    const exportData = async (type: "articles" | "users" | "comments" | "full") => {
        await confirm({
            ...
            onConfirm: async () => {
                ...
                setTimeout(() => {
                    const mockSize =
                        type === "full" ? 1048576 : type === "articles" ? 256000 : type === "users" ? 128000 : 64000;
                    const mockCount =
                        type === "full" ? 2500 : type === "articles" ? 1250 : type === "users" ? 500 : 890;
                        ...
                        <div className={styles.tableHeader}>
                            ...
                            <div className={styles.tableActions}>
                                <button
                                    ...
                                    onClick={() =>
                                        activeTab === "backups" ? createBackup("full") : exportData("full")
                                    }
                                >
                                    <FaPlus />
                                                ...
                                                <td>
                                                    <div className={styles.timeInfo}>
                                                        ...
                                                        {(backup as BackupRecord).completedAt ? (
                                                            <div>
                                                                <FaCheckCircle />{" "}
                                                                {formatDate((backup as BackupRecord).completedAt)}
                                                            </div>
                                                        ) : null}
                                                    </div>
                                                </td>
                                    ...
                                    {currentItems.length > 0 ? (
                                        currentItems.map((exportItem) => (
                                            <tr key={exportItem.id}>
                                                ...
                                                <td>
                                                    <span
                                                        className={`${styles.statusBadge} ${styles[exportItem.status]}`}
                                                    >
                                                        <span className={styles.statusIndicator}></span>
