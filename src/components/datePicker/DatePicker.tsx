...
const DatePicker: React.FC<DatePickerProps> = ({
                ...
                <div className={styles.datePickerHeader}>
                    <div className={styles.headerNavigation}>
                        <div className={styles.yearMonthNavigation}>
                            {picker !== "year" && (
                                <>
                                    <button type="button" className={styles.navButton} onClick={() => changeYear("prev")}>
                                        «
                                    </button>
                                    {picker !== "month" && (
                                        <button type="button" className={styles.navButton} onClick={() => changeMonth("prev")}>
                                            ‹
                                        </button>
                                    )}
                                </>
                            ...
                            {picker !== "year" && (
                                <>
                                    {picker !== "month" && (
                                        <button type="button" className={styles.navButton} onClick={() => changeMonth("next")}>
                                            ›
                                        </button>
                                    )}
                                    <button type="button" className={styles.navButton} onClick={() => changeYear("next")}>
                                        »
                                    </button>
                                </>
                            )}
    ...
    return (
        <div className={`${styles.datePicker} ${className}`} style={style} ref={dropdownRef}>
            ...
            {isOpen && !disabled && (
                <div
                    className={`${styles.datePickerDropdown} ${picker === "time" ? styles.timeOnly : isShowTime ? styles.withTime : ""}`}
                >
                    {picker !== "time" && (
